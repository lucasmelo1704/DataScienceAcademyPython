...
with st.sidebar:
    ...
    def save_groq_key():
        st.session_state["groq_api_key"] = st.session_state["groq_input"]
        st.session_state["groq_input"] = ""  # Limpa o campo após Enter
    ...
    st.text_input(
        ...
        key="groq_input",
        on_change=save_groq_key,
        help="Obtenha sua chave em https://console.groq.com/keys"
    )

    # Mensagem de confirmação após Enter
